...
public class ModTrimMaterials {
    public static final ResourceKey<TrimMaterial> AZURITE = ResourceKey.create(Registries.TRIM_MATERIAL, ResourceLocation.fromNamespaceAndPath(MCForgeCourseMod.MOD_ID, "azurite"));
